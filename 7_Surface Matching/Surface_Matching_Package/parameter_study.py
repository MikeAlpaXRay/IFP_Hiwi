...
def main():
    ...
    relativeSamplingStep_Range = [0.1, 0.5, 2, "c"]
    relativeDistanceStep_Range = [0.1, 0.5, 2, "c"]
    numAngles_Range = [0, 50, 2, "c"]
    relativeSceneSampleSte_Range = [0.1, 0.5, 2, "c"]
    relativeSceneDistance_Range = [0.1, 0.5, 2, "c"]
